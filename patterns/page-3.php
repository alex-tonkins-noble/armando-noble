 ...
 * Slug: armando-noble/page-layout-three
...
<!-- wp:post-title {"style":{"typography":{"fontSize":"70px"}},"className":"is-style-armando-noble-vertical-text"} /-->
</div></div>
<!-- /wp:media-text -->
...
<div class="wp-block-columns">
	...
	<div class="wp-block-column is-vertically-aligned-top">
		<!-- wp:paragraph {"align":"right","fontSize":"small"} --><p class="has-text-align-right has-small-font-size"><em><?php echo esc_html_x( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'sample content', 'armando-noble' ); ?></em></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:column -->
</div>
<!-- /wp:columns -->
<!-- wp:paragraph -->
<p><?php echo _x( '<strong>Pellentesque efficitur nisi enim, sed fermentum quam efficitur sed.</strong> Donec pulvinar, ex vitae facilisis fringilla, quam nulla dictum mi, viverra scelerisque quam lectus vitae dolor. Quisque gravida sed tellus sed fringilla. Ut eu mattis erat.', 'sample content', 'armando-noble' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
...
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html_x( 'Sed consequat, quam vel vulputate bibendum, sem ipsum feugiat purus, at porta elit lectus non eros. Aenean at lobortis sem. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.', 'sample content', 'armando-noble' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
