 ...
 * Slug: armando-noble/media-overlap
 * Categories: elements
...
<div class="wp-block-media-text__content">
	...
	<p class="has-large-font-size"><strong><?php echo esc_html_x( 'This text was added to show how you can create designs using block patterns.', 'sample content', 'armando-noble' ); ?></strong></p>
	<!-- /wp:paragraph -->
	<!-- wp:group {"backgroundColor":"black","textColor":"white","className":"is-style-armando-noble-media-overlap"} -->
	<div class="wp-block-group is-style-armando-noble-media-overlap has-white-color has-black-background-color has-text-color has-background">
		<!-- wp:heading {"textColor":"white"} --><h2 class="has-white-color has-text-color"><?php echo esc_html_x( 'Heading', 'sample-content', 'armando-noble' ); ?></h2>
		<!-- /wp:heading -->
