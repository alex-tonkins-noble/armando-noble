...
const themeURL = "/wp-content/themes/armando-noble/build/";
...
const base = glob
	.sync("./src/scripts/**.js", "./src/scripts/blocks/**.js")
	.reduce(function (obj, el) {
		obj[
			path.parse(el).dir.replace(/^(\.\/src)/, "") + "/" + path.parse(el).name
		] = el;
		return obj;
	}, {});

const acfblocks = glob.sync("./src/scripts/blocks/**.js").reduce(function (
	obj,
	el
) {
	obj[
